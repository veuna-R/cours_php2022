...
<head>
    ...
    <title>Cours PHP2022 - Fiche employé <?php echo $fiche['id_employes']; ?></title>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 bg-white p-5">
            <div class="row jumbotron bg-light">
                <div class="col-sm-12">
                    <h1 class="text-center">Cours PHP2022 - Employé<?php if ($fiche['sexe'] == 'f') {?>e<?php }echo " " . $fiche['prenom'] . " " . $fiche['nom'];?></h1>
                    <p class="lead alert alert-secondary text-center mt-4">Modification d'un employé</p>
                </div>
            </div><!-- fin row -->
            <!-- fin du jumbotron -->
