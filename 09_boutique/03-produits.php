...
<html lang="fr">
  ...
  <body>
    <main class="container m-5 mx-auto p-4">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="text-center display-3">La Boutique - Découvrez nos produits!</h1><br>
                <?php
                    ...
                    echo "<table class=\"table table-striped table-secondary\">";
                        echo "<thead>
                            ...
                            echo "<td><img src=\"" . $ligne['photo'] . "\" width=\"150\"></td>";
                            ...
                            echo "<td><a href=\"fiche-produit.php?id_produit=" . $ligne['id_produit']. "\">Voir sa fiche</a></td>";
                            echo "</tr>";
                            }
                    echo "</table>"
                ?>
