...
<head>
    <title>La boutique - Produits #<?php echo $fiche['id_produit']; ?></title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="card mx-auto" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo "Description : " . ucfirst($fiche['description']) . "<br> Taille : " . ucfirst($fiche['taille']) . "<br> Public : ";
                                                ...
                                                } elseif ($fiche['stock'] == 0) {
                                                        echo "<p class=\"alert alert-warning\">Attention, il ne reste plus" . strtolower($fiche['categorie']) . " en stock.</p>";
                                                } else {
